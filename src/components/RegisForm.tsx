    ...
    return (
        <>
          ...
          />
           ...
           <FormControl  variant="outlined">
          <InputLabel htmlFor="outlined-adornment-password">Confirma tu Password</InputLabel>
          <OutlinedInput
            id="outlined-adornment-password"
            type={showPassword ? 'text' : 'password'}
            value={rePassword}
          ...
          />
                    ...
                    <Text>Ya tienes una cuenta? <a style={{textDecoration: "none"}} href="/login">Inicia Sesion</a></Text>
